...
enum Key
  ...
  def shift?
    self == Key::LEFT_SHIFT || self == Key::RIGHT_SHIFT
  end

  def control?
    self == Key::LEFT_CONTROL || self == Key::RIGHT_CONTROL
  end

  def alt?
    self == Key::LEFT_ALT || self == Key::RIGHT_ALT
  end

  def super?
    self == Key::LEFT_SUPER || self == Key::RIGHT_SUPER
  end
end
